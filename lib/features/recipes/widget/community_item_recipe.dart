                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Text(
                            ...
                            style: AppStyles.s14w300whiteFFFDF9.copyWith(height: 1.2.h),
                            overflow: TextOverflow.ellipsis,
                            maxLines: 3,
                          ),
                        ),
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text('${widget.community.timeRequired} min', style: AppStyles.s12w400whiteFFFDF9,)
                              ],
                            ),
                            Row(
                              spacing: 5.w,
                              children: [
                                Text('${widget.community.reviewsCount}', style: AppStyles.s12w400whiteFFFDF9,),
                                SvgPicture.asset(
                                  AppIcons.community,
                                  colorFilter: ColorFilter.mode(AppColors.whiteBeigeFFFDF9, BlendMode.srcIn),
                                  width: 12.w,
